...
@Component({
  selector: 'app-invoice-detail-default',
  templateUrl: './invoice-detail-default.component.html',
  styleUrls: [
    './invoice-detail-default.component.css',
    '../../../../assets/scss/plugins/_datepicker.scss'
  ]
})
export class InvoiceDetailDefaultComponent implements OnInit, OnDestroy {
  ...
  @Confirmable({title: 'Annuler la facture'})
  openConfirm(response?: any) {
    if (response) {
  ...
  removeItem(index: number) {
    ...
    else this.notification.error(null, 'DELETE_ERROR');
  }
